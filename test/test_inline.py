...
class Testinline(unittest.TestCase):
    ...
    def test_delimit(self):
        node = textnode.TextNode("This is text with a `code block` word", datatypes.TextTypes.TEXT_NAME.value, None)
        new_nodes = inline.split_nodes_delimiter([node], "`", datatypes.TextTypes.CODE_NAME.value)
    ...
    def test_multiple_text_nodes(self):
        nodes = [
            textnode.TextNode("test 1 * this part is bold* line",datatypes.TextTypes.TEXT_NAME.value,None),
            textnode.TextNode("test 2 **this part is bold?** line",datatypes.TextTypes.BOLD_NAME.value,None),
            textnode.TextNode("test 3 * this part should be code* line",datatypes.TextTypes.CODE_NAME.value,None)
            ]
        
        delimit_nodes = inline.split_nodes_delimiter(nodes, "*",datatypes.TextTypes.BOLD_NAME.value)

        should_be = [       
                textnode.TextNode("test 1 ",datatypes.TextTypes.TEXT_NAME.value,None),
                textnode.TextNode(" this part is bold",datatypes.TextTypes.BOLD_NAME.value,None),
    ...
    def test_no_closing_delimiter(self):
        node = textnode.TextNode("this line has no * closing delim", datatypes.TextTypes.TEXT_NAME.value,None )
        node2 = textnode.TextNode("this line * also has* no * closing delim", datatypes.TextTypes.TEXT_NAME.value,None )
    
        with self.assertRaises(RuntimeError):
            inline.split_nodes_delimiter([node],"*",datatypes.TextTypes.ITALIC_NAME.value)
            inline.split_nodes_delimiter([node2],"*",datatypes.TextTypes.ITALIC_NAME.value)
    
    def test_multiple_split(self):
        node1 = textnode.TextNode(
            " this should have *multiple code* blocks * that are outputed* for this",datatypes.TextTypes.TEXT_NAME.value,None)
    
        delimit_nodes = inline.split_nodes_delimiter([node1], "*",datatypes.TextTypes.CODE_NAME.value)
        ...
        should_be = [
            ...
            textnode.TextNode(
            " blocks ",datatypes.TextTypes.TEXT_NAME.value,None),
            textnode.TextNode(
            " that are outputed",datatypes.TextTypes.CODE_NAME.value,None),
            textnode.TextNode(
            " for this",datatypes.TextTypes.TEXT_NAME.value,None)
        ]
    ...
    def test_start_end_delimits(self):
        start_node = textnode.TextNode(
            "*this should have * a start code block",datatypes.TextTypes.TEXT_NAME.value,None)
        
        end_node = textnode.TextNode(
            " this should have a *end code block*",datatypes.TextTypes.TEXT_NAME.value,None)
        
        start_delimit = inline.split_nodes_delimiter([start_node], "*",datatypes.TextTypes.CODE_NAME.value)
        end_delimit = inline.split_nodes_delimiter([end_node], "*",datatypes.TextTypes.CODE_NAME.value)
    ...
    def test_split_nodes_links(self):
        ...
        datatypes.TextTypes.TEXT_NAME.value, None)
        
        new_nodes = inline.split_nodes_links([node])

        should_be = [
            textnode.TextNode("to boot dev", datatypes.TextTypes.LINK_NAME.value, "https://www.boot.dev"),
            textnode.TextNode(" This is text with a link and ", datatypes.TextTypes.TEXT_NAME.value,None),
            textnode.TextNode("to youtube", datatypes.TextTypes.LINK_NAME.value, "https://www.youtube.com/@bootdotdev"),
        ...
        should_be_2 = [
            textnode.TextNode("to boot dev", datatypes.TextTypes.LINK_NAME.value, "https://www.boot.dev"),
            textnode.TextNode(" This is text ", datatypes.TextTypes.TEXT_NAME.value,None),
            textnode.TextNode("with a middle link", datatypes.TextTypes.LINK_NAME.value, "https://www.middlelink.com"),
            textnode.TextNode(" a link and ", datatypes.TextTypes.TEXT_NAME.value,None),
            textnode.TextNode("to youtube", datatypes.TextTypes.LINK_NAME.value, "https://www.youtube.com/@bootdotdev"),
            textnode.TextNode(" huh", datatypes.TextTypes.TEXT_NAME.value,None)
        ]  
    ...
    def test_split_images(self):
        ...
        img_node = textnode.TextNode(
            "This is a with image and ![image anchor](image_urls/images)",datatypes.TextTypes.TEXT_NAME.value,None)
        
        new_img_node = inline.split_nodes_images([img_node])
        img_test = [
            textnode.TextNode("This is a with image and ", datatypes.TextTypes.TEXT_NAME.value, None),
            textnode.TextNode("image anchor",  datatypes.TextTypes.IMAGE_NAME.value, "image_urls/images")
            ]
        ...
        should_be_2 = [
            textnode.TextNode("boot img", datatypes.TextTypes.IMAGE_NAME.value, "https://www.boot.dev/img"),
            textnode.TextNode(" This is a image and ", datatypes.TextTypes.TEXT_NAME.value,None),
            textnode.TextNode("youtube logo", datatypes.TextTypes.IMAGE_NAME.value, "https://www.youtube.com/logo"),
        ]       
    ...
    def test_text_to_textnodes(self):
        ...
        should_be = [
            ...
            textnode.TextNode(" word and a ", datatypes.TextTypes.TEXT_NAME.value,None),
            ...
            textnode.TextNode("obi wan image", datatypes.TextTypes.IMAGE_NAME.value, "https://i.imgur.com/fJRm4Vk.jpeg"),
            textnode.TextNode(" and a ", datatypes.TextTypes.TEXT_NAME.value,None),
            textnode.TextNode("link", datatypes.TextTypes.LINK_NAME.value, "https://boot.dev"),
        ]
