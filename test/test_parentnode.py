"""parentnode class module unit test"""
import unittest
import logging
...
class TestParentNode(unittest.TestCase):
    ...
    def test_to_html(self):
        ...
        LOG.info("%s should match %s", node1.to_html(), test1)
        ...
        LOG.info("%s should match %s", node2.to_html(), {test2} )
    ...
    def check_missing_params(self):
        ...
        with self.assertRaises(AssertionError):
            ...
            ParentNode("p")
            LOG.info("parent node errors if children is None")
