"""textnode class module unit test"""
import unittest
import logging
...
class TestTextNode(unittest.TestCase):
    ...
    def test_text_to_html(self):
        ...
        LOG.info("%s is converted to %s ",node1, hmtl_node1.to_html())
        ...
        LOG.info("%s is converted to %s", node1, hmtl_node2.to_html())
        ...
        LOG.info("%s is converted to %s",node1, hmtl_node3.to_html())
        ...
        LOG.info("%s is converted to %s", node4, hmtl_node4.to_html())
